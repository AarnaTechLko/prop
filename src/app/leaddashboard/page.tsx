...
export default function DashboardPage() {
  ...
  const handleNextStep = () => {
    console.log("Proceeding to next step with file:", file?.name);
            ...
            <div className="pt-6 mt-6">
              ...
              {selectedTab === 'scoreFilter' && (
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    {/* Right Panel */}
                    <div className="w-full md:w-3/5 p-6 bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col justify-between">
                      <div>
                        ...
                        <div className="mt-4 flex space-x-3">
                          <button className="px-4 py-2 border border-gray-300 rounded text-xs text-gray-700 hover:bg-gray-100 transition">
                            Show Preview
                          </button>
                          <button className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 text-xs transition">
                  ...
                  <div className="mt-6 flex justify-between">
                    <button
                      ...
                      className="px-4 py-2 border border-gray-400 text-white bg-gray-400 text-xs rounded hover:bg-gray-500 transition"
                    >
                      Previous
                    </button>
                    <button
                      onClick={handleNextStepFromScoreFilter}
                      className="px-4 py-2 bg-gray-400 text-white text-xs rounded hover:bg-gray-500 transition"
                    >
                      Next
                    </button>
                  </div>
              ...
              {selectedTab === 'createLists' && (
                <div>
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <button
                          ...
                          className="text-sm px-4 py-2 rounded border border-gray-200 text-white hover:bg-gray-100 transition"
                        >
                          Clear Selection
                        </button>
                        <button
                  ...
                  <div className="mt-6 flex justify-between">
                    <button
                      onClick={handlePrevStepFromCreateList}
                      className="px-4 py-2 border border-gray-300  bg-gray-400 text-white text-xs rounded hover:bg-gray-500 transition"
                    >
                      Previous
                    </button>
                    <button
                      onClick={handleNextStepFromCreateList}
                      className="px-4 py-2 bg-gray-400 text-white text-xs rounded hover:bg-gray-500 transition"
                    >
                      Next
                    </button>
              ...
              {selectedTab === 'market' && (
                <div>
                  ...
                  <div className="mt-6">
                    <button
                      onClick={handlePrevStepFromMarket}
                      className="px-4 py-2 bg-gray-400 border border-gray-300 text-white text-xs rounded 
