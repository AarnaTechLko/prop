  ...
  const handleNewListClick = () => {
    ...
    if (newListName) {
      const newList: LeadList = {
        id: (leadLists.length + 1).toString(),
        name: newListName,
        leadsCount: 0,
      };
            ...
            <ul>
              {leadLists.map((list) => (
                <li
                  ...
                  className={`mb-4 cursor-pointer rounded-lg p-4 shadow-sm transition-shadow border text-sm ${selectedListId === list.id
            ...
            {!selectedListId ? (
              <div className="flex flex-col items-center justify-center text-center text-gray-700 max-w-xl mx-auto mt-40">
                ...
                <p className="mb-6 text-sm text-gray-500">
                  Choose a lead list from the sidebar to view and manage its leads,<br />
